    ...
    return (
        ...
        >
            <Box pt={"200px"} pl={"170px"}>
                <Box fontSize={"40px"} color={"yellow.500"} fontWeight={"thin"}>JavaScript Framework</Box>
                <Box mt={"50px"} fontWeight={"thin"}>
                    <Flex color={"white"} pl={"20px"} fontSize={"20px"} gap={"100px"} alignItems="center">

                        <Box w={"150px"} pr="10px">React Js</Box>
                    ...
                    <Flex color={"white"} pl={"20px"} fontSize={"20px"} gap={"100px"} alignItems="center">
                        <Box w={"150px"} pr="10px">Next Js</Box>
                        <Box w={"500px"} boxShadow={"0px 0px 5px gold"} border={"1px solid"} borderColor={"yellow.500"} borderRadius={"20px"} h={"5px"}>
                            <Box w={"80%"} h={"100%"} bgColor={"yellow.500"}></Box>
                        </Box>
                    </Flex>
                    <Flex color={"white"} pl={"20px"} fontSize={"20px"} gap={"100px"} alignItems="center">
                        <Box w={"150px"} pr="10px">Angular</Box>
                        <Box w={"500px"} boxShadow={"0px 0px 5px gold"} border={"1px solid"} borderColor={"yellow.500"} borderRadius={"20px"} h={"5px"}>
